...
namespace LMS.Infrastructure.HtmlHelpers
{
    public static class HtmlRibbonHelper
    {
        ...
        public static IHtmlString RibbonItem(this HtmlHelper htmlHelper, string id, string label, string description,
            IHtmlString iconHtmlString = null, string style = null)
        {
